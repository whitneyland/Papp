/*
 ...
 LW: Modified to support an option 'controlContext'
 This option allows data to be associated with an instance of select2,
 and then accessed during the query callback function.

 Without this, the query callback cannot respond dynamically based
 on it's position in the row of a table, or in relation to other select2 instances.
 */
/*
...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            // LW
            //this.container.find("a.select2-choice").attr("tabindex", this.elementTabIndex);
            ...
            this.resultsPage = 0;
            this.context = null;
            this.controlContext = this.opts.controlContext;
